...
项目目标不是“定罪”，而是以更克制、可追溯的方式记录：

- 判罚争议
- 裁判执法问题
- FIFA / 足协治理争议
- 种族歧视相关指控
- 其他已被广泛报道、具备公共讨论价值的事件
...
- 自定义访问地址: <https://i.ioodu.com/fairarchive/>

> 注：自定义域名可能存在 CDN / 浏览器缓存，代码已更新但页面暂未刷新时，可尝试强制刷新或稍等数分钟。
...
1. 官方声明 / 官方裁定
2. Reuters / AP / BBC / Guardian / ESPN / NYT / Al Jazeera 等
3. 其他可交叉验证媒体

### 3. 尽量保留回应

如果存在当事方、足协、FIFA、裁判负责人、俱乐部或球员回应，优先补进 `response` 字段。
